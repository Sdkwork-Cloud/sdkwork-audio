...
const baselinePath = path.join(root, 'database/ddl/baseline/postgres/0001_audio_legacy_baseline.sql');
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'audio_', owner: 'media-platform', domain: 'audio' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into audio database contract\n`);
