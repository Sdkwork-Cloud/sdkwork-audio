//! Sound effect service errors

use thiserror::Error;

/// Sound effect service error
#[derive(Error, Debug)]
...
/// Result type for sound effect service
pub type SoundEffectServiceResult<T> = Result<T, SoundEffectServiceError>;
